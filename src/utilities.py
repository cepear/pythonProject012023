...
ROOT_DIR = dirname(dirname(abspath(__file__)))  # after refactoring :  C:\dev22\pythonProject012023\src
# before refactoring when utilities were inder main folder:  dirname(abspath(__file__))
